...
const addComplaint = (payload, files) =>
...
const addComplaintLog = (payload, user_pk) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const con = yield DatabaseConfig_1.DatabaseConnection();
    try {
      yield con.BeginTransaction();
      payload.encoder_pk = user_pk;
      const sql_update_complaint_status = yield con.Modify(
...
const getComplaintLogTable = (complaint_pk) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const con = yield DatabaseConfig_1.DatabaseConnection();
    try {
...
const getSingleComplaint = (complaint_pk) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
      ...
      single_complaint.user = yield con.QuerySingle(
        `Select * from vw_users where user_pk = @user_pk`,
        {
          user_pk: single_complaint.reported_by,
        }
      );
      single_complaint.user.pic = yield useFileUploader_1.GetUploadedImage(
        single_complaint.user.pic
      );
      single_complaint.status = yield con.QuerySingle(
        `Select * from status where sts_pk = @sts_pk;`,
        {
...
const getComplaintTable = (reported_by) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const con = yield DatabaseConfig_1.DatabaseConnection();
    try {
      yield con.BeginTransaction();
      ...
      `,
        ...
        complaint.user = yield con.QuerySingle(
          `Select * from vw_users where user_pk = @user_pk`,
          {
            user_pk: complaint.reported_by,
          }
        );
        complaint.user.pic = yield useFileUploader_1.GetUploadedImage(
          complaint.user.pic
        );
      }
      con.Commit();
...
//messages
const addComplaintMessage = (payload) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const con = yield DatabaseConfig_1.DatabaseConnection();
    try {
      yield con.BeginTransaction();
...
const getComplaintMessage = (complaint_pk) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const con = yield DatabaseConfig_1.DatabaseConnection();
    try {
      const table_messages = yield con.Query(
      ...
      for (const message of table_messages) {
        message.user = yield con.QuerySingle(
          `SELECT * from vw_users where user_pk = @user_pk`,
          {
            user_pk: message.sent_by,
          }
        );
        message.user.pic = yield useFileUploader_1.GetUploadedImage(
          message.user.pic
        );
      }
      return {
