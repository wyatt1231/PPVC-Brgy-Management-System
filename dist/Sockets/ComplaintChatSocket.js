...
const ComplaintChatSocket = (io) => {
    io.of(SOCKET_NAMESPACE)
        ...
        socket.on("joinRoom", (complaint_pk) => {
...
exports.default = ComplaintChatSocket;
//# sourceMappingURL=ComplaintChatSocket.js.map