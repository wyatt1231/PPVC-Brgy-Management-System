...
const RoomController = (app) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    router.post("/getRoomDataTable", Authorize_1.default("admin"), (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        const payload = req.body;
        res.json(yield RoomRepository_1.default.getRoomDataTable(payload));
    }));
    router.post("/addRoom", Authorize_1.default("admin"), (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        const payload = req.body;
