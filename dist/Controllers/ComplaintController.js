...
const ComplaintController = (app) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    router.post("/addComplaint", Authorize_1.default("admin"), (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    router.post("/getSingleComplaint", Authorize_1.default("admin"), (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        const complaint_pk = req.body.complaint_pk;
        res.json(yield ComplaintRepository_1.default.getSingleComplaint(complaint_pk));
    }));
    router.post("/addComplaintLog", Authorize_1.default("admin"), (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        const payload = req.body;
        res.json(yield ComplaintRepository_1.default.addComplaintLog(payload, req.user_pk));
    }));
    router.post("/addComplaintMessage", Authorize_1.default("admin"), (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        const payload = req.body;
